...
int main() {
    ...
    if (vecOrd.size()%2 == 0) {
        ...
        cout << vecOrd[(vecOrd.size()/2)] << endl;
    }
    ...
    double variancia = sumVariancia/((double)vecOrd.size() - 1);
    cout << "Variancia: " << sumVariancia/((double)vecOrd.size() - 1) << endl;
